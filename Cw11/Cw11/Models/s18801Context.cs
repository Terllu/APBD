...
{
    public partial class s18801Context : DbContext
    {
        public s18801Context()
        {
        }

        public s18801Context(DbContextOptions<s18801Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18801;Integrated Security=True");
            }
        }
